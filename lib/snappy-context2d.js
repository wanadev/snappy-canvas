...
class SnappyContext2D {
    ...
    render() {
        ...
        var operations = {
            ...
            setLineDash: {fn: function fn(operation, operationName, ...values) {
            ...
            lineDashOffset: {fn: function fn(operation, operationName, ...values) {
                ctx.lineDashOffset = values[0] * (contextStatus.scaleLineWidth ? contextStatus.scale : 1) | 0;
            }},
